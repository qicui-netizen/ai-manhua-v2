  ...
  return (
    <div className="flex min-h-full flex-col pb-32">
      <div className="px-5 pt-8 pb-4">
        <h1 className="mb-1 text-xl font-extrabold text-[var(--color-text)]">说说发生了什么？</h1>
  ...
  return (
    <div className="flex min-h-full flex-col pb-36">
      ...
      <div className="px-5">
        ...
        >
          <span className="text-[13px] font-semibold text-[var(--color-text)]">剧情摘要（起承转合）</span>
        ...
        {plotExpanded && (
          <div className="mb-4 flex flex-col gap-2">
            ...
            <p className="mt-1 text-xs leading-relaxed text-[var(--color-text-dim)]">{expandedPlot.plot}</p>
          </div>
        )}
